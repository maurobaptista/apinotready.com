<div class="bg-gradient relative w-full top-0 h-40 md:h-64">
    ...
    <h1 class="max-w-6xl mx-auto text-center pt-40 text-white">
        <p>Made by <a href="https://www.maurobaptista.com" class="hover:font-bold">Mauro Baptista</a></p>
        <div class="flex flex-row justify-center">
            <a href="https://twitter.carnou.com" class="m-4 hover:font-bold">Twitter</a>
            <a href="https://github.carnou.com" class="m-4 hover:font-bold">Github</a>
            <a href="https://www.carnou.com" class="m-4 hover:font-bold">Blog</a>
            <a href="https://linkedin.carnou.com" class="m-4 hover:font-bold">Linkedin</a>
        </div>
    </h1>
</div>
